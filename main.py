...
def main(config):
    ...
    f1_mac_test, auc_test, Recall,gmean = model.train()
    print("F1-Macro: {}".format(f1_mac_test))
    print("AUC: {}".format(auc_test))
    print("Recall: {}".format(Recall))
    print("G-means: {}".format(gmean))
...
def get_args():
    ...
    parser.add_argument('-config', '--config',default='./config/gdn_yelpchi.yml', type=str, help='path to the config file')
